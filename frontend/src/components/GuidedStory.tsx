...
const GuidedStory: React.FC = () => {
  ...
  const generateStory = () => {
    ...
    const finalPrompt = `A ${guidedData.character} and ${guidedData.companion} in ${guidedData.setting}, 
      facing a ${guidedData.challenge}, with a ${guidedData.tone} tone, 
      focusing on ${guidedData.values.join(', ')}.`;
  ...
  const isFormValid =
    guidedData.theme && guidedData.character && guidedData.setting;
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 mt-2 flex-1 overflow-y-auto pb-6">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {[
              ...
              <button
                ...
                className={`p-3 text-left rounded-lg border-2 transition-all ${guidedData.theme === theme
      ...
      <Card className="shadow-lg">
        ...
        <CardContent>
          <input
            ...
            onChange={(e) =>
              setGuidedData({ ...guidedData, character: e.target.value })
            }
            placeholder="e.g., curious rabbit, brave girl"
            className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-purple-400 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
          />
        </CardContent>
      </Card>
      ...
      <Card className="shadow-lg">
        ...
        <CardContent>
          <input
            ...
            onChange={(e) =>
              setGuidedData({ ...guidedData, companion: e.target.value })
            }
      ...
      <Card className="shadow-lg">
        ...
        <CardContent>
          <input
            ...
            onChange={(e) =>
              setGuidedData({ ...guidedData, setting: e.target.value })
            }
          ...
          <div className="space-y-2">
            {[
              ...
              <button
                key={challenge}
                onClick={() =>
                  setGuidedData({ ...guidedData, challenge })
                }
                className={`w-full p-2 text-left rounded border transition-all ${guidedData.challenge === challenge
                    ? 'border-purple-400 bg-purple-50 dark:bg-purple-900/20'
                    : 'border-gray-200 hover:border-purple-200'
                  }`}
              >
      ...
      <Card className="shadow-lg">
        ...
        <CardContent>
          <div className="space-y-2">
            {['silly', 'adventurous', 'gentle', 'mysterious', 'playful', 'heartwarming'].map(
              (tone) => (
                <button
                  key={tone}
                  onClick={() => setGuidedData({ ...guidedData, tone })}
                  className={`w-full p-2 text-left rounded border transition-all ${guidedData.tone === tone
                      ? 'border-purple-400 bg-purple-50 dark:bg-purple-900/20'
                      : 'border-gray-200 hover:border-purple-200'
                    }`}
                >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            {[
              ...
              <button
                ...
                className={`p-2 text-sm rounded border transition-all ${guidedData.values.includes(value)
                    ? 'border-purple-400 bg-purple-50 dark:bg-purple-900/20'
                    : 'border-gray-200 hover:border-purple-200'
                  }`}
              >
