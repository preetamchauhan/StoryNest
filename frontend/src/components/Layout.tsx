          ...
          <div className="flex items-center space-x-1 sm:space-x-2">
            ...
            <div className="flex items-center space-x-1">
              ...
              <div className="flex space-x-1">
                <button
                  onClick={() => setAge(6)}
                  className={`px-1 sm:px-2 py-1 text-xs font-bold rounded-full transition-all duration-200 ${age === 6
                ...
                <button
                  onClick={() => setAge(10)}
                  className={`px-1 sm:px-2 py-1 text-xs font-bold rounded-full transition-all duration-200 ${age === 10
