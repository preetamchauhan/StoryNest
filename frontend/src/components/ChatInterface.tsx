...
const ChatInterface: React.FC<ChatInterfaceProps> = ({
    ...
    switch (mode) {
      case "surprise":
        return {
          icon: "🎲",
          title: t("surpriseMe"),
          backText: "Back to Surprise",
        };
      case "guided":
        return {
          icon: "📖",
          title: t("guidedStory"),
          backText: "Back to Guided",
        };
      case "freeform":
        return {
          icon: "✍️",
          title: t("myOwnIdea"),
          backText: "Back to My Idea",
        };
      default:
        return {
          icon: "🤖",
  ...
  return (
    <div
      className="flex-1 flex flex-col bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 
    ...
    >
      <div
        className="bg-gradient-to-r from-purple-100/90 to-pink-100/90 dark:bg-gradient-to-r
...
p-3 sm:p-4 flex-shrink-0 rounded-t-2xl"
        ...
        rounded-full flex items-center justify-center shadow-lg ${
          isStreaming ? "animate-pulse" : ""
            ...
            <div className="flex items-center gap-2">
              ...
              <h2
                className="font-bold text-base sm:text-lg bg-gradient-to-r from-purple-600 to-pink-600 
      ...
      >
        {events.map((event, index) => {
          if (event.type === "log") {
            return (
              <div
                key={index}
                className="flex items-start gap-2 sm:gap-4 animate-fade-in"
              >
                <div
            ...
            mt-1 shadow-md"
                ...
                <div
                  className="flex-1 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/30 
            ...
            sm:hover:-translate-x-2 transition-transform"
                >
                  <p
                    className="text-xs sm:text-sm leading-relaxed font-medium text-blue-800
          dark:text-blue-200 whitespace-pre-line"
                  >
                    {event.data.message}
                  </p>
                </div>
        ...
        dark:border-red-700 max-w-full sm:max-w-3xl"
                >
                  <div
                    className="text-xs sm:text-sm text-red-700 dark:text-red-300 font-medium 
          whitespace-pre-line"
                  >
                    {(() => {
        ...
        mt-1 shadow-md"
          ...
          transition-transform cursor-pointer hover:shadow-2xl"
            ...
            text-sm sm:text-base font-medium line-clamp-4"
                    ...
                    <div className="mt-3 text-center">
                      <span
                        className="text-sm sm:text-base text-purple-600 dark:text-purple-400 
              ...
              hover:bg-purple-200 dark:hover:bg-purple-800/40 transition-colors"
                  ...
                  <div className="mt-3">
                    <StoryActions
                      ...
                      size="small"
                      originalPrompt={
                        storyData.original_prompt || storyData.story_text
                      }
          ...
          if (event.type === "final") {
            return (
              <div key={index} className="flex items-start gap-2 sm:gap-4">
                <div
                  className="w-6 h-6 sm:w-8 sm:h-8 bg-green-500 rounded-full flex items-center 
        justify-center text-white text-xs sm:text-sm flex-shrink-0 mt-1 shadow-md"
                >
                  🗸
                </div>
                <div
                  className="flex-1 bg-gradient-to-br from-green-100 to-emerald-100 dark:from-green-900/30 
        ...
        {(() => {
          ...
          const hasCompleteStory = events.some(
            (e) => e.type === "story_complete"
          );
            ...
            sm:hover:translate-x-2 transition-transform"
                ...
                text-sm sm:text-base font-medium"
                      >
                        {streamingText}
                        {isStreaming && (
                          <span className="animate-bounce text-purple-500 ml-1">
                            ✨
                          </span>
                        )}
                      </p>
      ...
      shadow-md"
            ...
            <div
              className="flex-1 bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900/30 
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="flex space-x-1">
                  <div
                    className="w-2 h-2 sm:w-3 sm:h-3 bg-gradient-to-r from-purple-400 to-pink-400 
